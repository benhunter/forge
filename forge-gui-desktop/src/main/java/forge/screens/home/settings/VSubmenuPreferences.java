...
public enum VSubmenuPreferences implements IVSubmenu<CSubmenuPreferences> {
    ...
    private final JCheckBox cbAiPicker = new OptionsCheckBox(localizer.getMessage("lblAiPicker"));
    ...
    VSubmenuPreferences() {
        ...
        pnlPrefs.add(new NoteLabel(localizer.getMessage("nlAiPicker")), descriptionConstraints);
